...
public class EmployeeServiceImpl implements EmployeeService{
	...
	public List<Employee> getEmployeesByCity(String city) {
		return repo.getEmployeesByCity(city);
	}

	@Override
	public List<String> getAllEmployeeNames() {
		return repo.getAllEmployeeNames();
	}
	...
	@Override
	public List<Employee> getEmployeesByCityNative(String city) {
		return repo.getEmployessByCityNative(city);
	}

	@Override
	public int updateEmployeeCity(Long id, String city) {
		return repo.updateEmployeeCity(id, city);
	}

	@Override
	public int deleteEmployeesByCity(String city) {
	    return repo.deleteEmployeesByCity(city);
	}
